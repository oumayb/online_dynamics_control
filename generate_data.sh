...
python odc/generate_simulations_pinocchio.py --idx_start 0 --idx_end 2000 --target_dir datasets/cartpole_128_128/test/ \
--with_cart 1 --max_initial_v 0 --min_bar_length 0.4 --max_bar_length 0.9 --lower_limit 0 --upper_limit 4 \
--max_initial_v 0 --min_cart_length_radius_ratio 3 --max_cart_length_radius_ratio 7 --duration 5

python odc/generate_simulations_pinocchio.py --idx_start 0 --idx_end 1000 --target_dirdatasets/ cartpole_128_128/eval/ \
--with_cart 1 --max_initial_v 0 --min_bar_length 0.4 --max_bar_length 0.9 --lower_limit 0 --upper_limit 4 \
